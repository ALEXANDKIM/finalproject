...
if (empty($username) || empty($email) || empty($password) || empty($status)) {
    ...
    if (mysqli_query($conn, $sql)) {
        try {
            ...
            $mail->Body = 'Please click the "verify" link to verify your email: <a href="http://localhost/finalproject/verified.php?email='.$email.'&code='.$verification_code.'">Verify</a>';  // Email body
